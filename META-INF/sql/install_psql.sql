...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM ad_column WHERE name = 'workedhours' AND entitytype = 'U' AND columnname = 'workedhours' AND ad_table_id = 417) THEN
        ...
        VALUES
        (next_value, 0, 0, 'Y', NOW(), NOW(), 100, 100, 'workedhours', NULL, NULL, 0.0, 'U', 'workedhours', 417, 11, NULL, NULL, 10, NULL, 'N', 'N', 'N', 'Y', NULL, 'N', NULL, 'N', 'N', NULL, NULL, NULL, NULL, 'N', element_id, NULL, 'N', 'N', NULL, NULL, NULL, 'N', 'Y', NULL, 'Y', NULL, 'N', 'N', NULL, NULL, 'N', NULL, NULL, 'N', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL);
